...
[![Tests](https://github.com/jeffersongoncalves/laravel-calendly/actions/workflows/run-tests.yml/badge.svg)](https://github.com/jeffersongoncalves/laravel-calendly/actions/workflows/run-tests.yml)
